...
//ModelEditor::ModelEditor(Model &model, QObject* parent)
//	: m_model(model)
//	, m_modelsaver(new ModelSaver)
//	, m_currentStep(0)
//	, QObject(parent)
//{
//	QObject::connect(&m_model, &Model::_changed, this, &ModelEditor::_saveModel);
//	Config::initTypes("./types.json");
//}

//void ModelEditor::_saveModel()
//{
//	m_modelsaver->saveJson(m_model.toJson(), ++m_currentStep);
//}
